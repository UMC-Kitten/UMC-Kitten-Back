...
public class FinancialLedgerController {
    ...
    public ApiResponse<FinancialLedgerResponseDTO.JoinFinancialLedgerResultDTO> joinFinancialLedger(@PathVariable(name = "userId") Long userId, @RequestBody @Valid FinancialLedgerRequestDTO.JoinFinancialLedgerDTO req){
